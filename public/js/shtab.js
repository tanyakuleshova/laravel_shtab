$(function () {
	...
	$('ul.tabs__container li:last').addClass('tabs__link--current');
	$('div.tabs__item:last').addClass("tabs__item--current");

	$('ul.tabs__container li').click(function(e) {
		localStorage.setItem('current', $(e.target).attr('data-tab'));
		$('ul.tabs__container li').removeClass('tabs__link--current');
		$(this).addClass('tabs__link--current');
		$('div.tabs__item').removeClass('tabs__item--current');
		$("#" + $(e.target).attr('data-tab')).addClass("tabs__item--current");
	});
	...
	// $('#support-us').click(function() {
	// 	$('ul.tabs__container li:first').addClass('tabs__link--current');
	// 	$('div.tabs__item:last').addClass("tabs__item--current");
	// });
	//
	// $('#join-us').click(function() {
	// 	$('ul.tabs__container li:nth-child(2)').addClass('tabs__link--current');
	// 	$('div.tabs__item:nth-child(2)').addClass("tabs__item--current");
	// });
	// var l = $(".tabs__link");
	// l.length > 0 && l.click(function () {
	// 	var s = $(this).attr("data-tab");
	// 	l.removeClass("tabs__link--current"), $(".tabs__item").removeClass("tabs__item--current"),
	// 	$(this).addClass("tabs__link--current"), $("#" + s).addClass("tabs__item--current")
// })
// 	,
